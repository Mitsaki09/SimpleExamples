        ...
        GrpcMarshalling.negotiated(request, (reader, writer) =>
          (method match {
            ...
            case "SayPigInfo" =>
                ...
                GrpcMarshalling.unmarshal(request.entity.dataBytes)(PigInfoRequestSerializer, mat, reader)
                  .flatMap(implementation.sayPigInfo(_))
                  .map(e => GrpcMarshalling.marshal(e, eHandler)(PigInfoReplySerializer, writer, system))
            
            case "SayHumanInfo" =>
                
                GrpcMarshalling.unmarshal(request.entity.dataBytes)(HumanRequestSerializer, mat, reader)
                  .flatMap(implementation.sayHumanInfo(_))
                  .map(e => GrpcMarshalling.marshal(e, eHandler)(HumanReplySerializer, writer, system))
            
            case "SayWorkInfoHuman" =>
                
                GrpcMarshalling.unmarshal(request.entity.dataBytes)(WorkInfoHumanRequestSerializer, mat, reader)
                  .flatMap(implementation.sayWorkInfoHuman(_))
                  .map(e => GrpcMarshalling.marshal(e, eHandler)(WorkInfoHumanReplySerializer, writer, system))
            
            case "HouseAndCitizen" =>
                
                GrpcMarshalling.unmarshal(request.entity.dataBytes)(CitizenSerializer, mat, reader)
                  .flatMap(implementation.houseAndCitizen(_))
                  .map(e => GrpcMarshalling.marshal(e, eHandler)(HouseSerializer, writer, system))
