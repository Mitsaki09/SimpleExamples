...
final case class HumanReply(
    ...
    def withId(__v: _root_.scala.Long): HumanReply = copy(id = __v)
    def withFirstName(__v: _root_.scala.Predef.String): HumanReply = copy(firstName = __v)
    def withMiddleName(__v: _root_.scala.Predef.String): HumanReply = copy(middleName = __v)
    def withLastName(__v: _root_.scala.Predef.String): HumanReply = copy(lastName = __v)
    def withWeight(__v: _root_.scala.Long): HumanReply = copy(weight = __v)
    ...
    def companion = com.example.helloworld.HumanReply
    // @@protoc_insertion_point(GeneratedMessage[HumanReply])
}

object HumanReply extends scalapb.GeneratedMessageCompanion[com.example.helloworld.HumanReply] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.example.helloworld.HumanReply] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.example.helloworld.HumanReply = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.example.helloworld.HumanReply] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = HelloworldProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = HelloworldProto.scalaDescriptor.messages(5)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.example.helloworld.HumanReply(
    id = 0L,
    firstName = "",
    middleName = "",
    lastName = "",
  ...
  implicit class HumanReplyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.example.helloworld.HumanReply]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.example.helloworld.HumanReply](_l) {
  ...
  ): _root_.com.example.helloworld.HumanReply = _root_.com.example.helloworld.HumanReply(
    id,
    firstName,
    middleName,
    lastName,
