...
@SerialVersionUID(0L)
final case class WorkInfoHumanReply(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[WorkInfoHumanReply] {
    @transient
    ...
    def withPosition(__v: _root_.scala.Predef.String): WorkInfoHumanReply = copy(position = __v)
    ...
    def clearHumanRequest: WorkInfoHumanReply = copy(humanRequest = _root_.scala.None)
    def withHumanRequest(__v: com.example.helloworld.HumanRequest): WorkInfoHumanReply = copy(humanRequest = Option(__v))
    ...
    def companion = com.example.helloworld.WorkInfoHumanReply
    // @@protoc_insertion_point(GeneratedMessage[WorkInfoHumanReply])
}

object WorkInfoHumanReply extends scalapb.GeneratedMessageCompanion[com.example.helloworld.WorkInfoHumanReply] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.example.helloworld.WorkInfoHumanReply] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.example.helloworld.WorkInfoHumanReply = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.example.helloworld.WorkInfoHumanReply] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = HelloworldProto.javaDescriptor.getMessageTypes().get(7)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = HelloworldProto.scalaDescriptor.messages(7)
  ...
  lazy val defaultInstance = com.example.helloworld.WorkInfoHumanReply(
    position = "",
    humanRequest = _root_.scala.None
  )
  implicit class WorkInfoHumanReplyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.example.helloworld.WorkInfoHumanReply]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.example.helloworld.WorkInfoHumanReply](_l) {
  ...
  ): _root_.com.example.helloworld.WorkInfoHumanReply = _root_.com.example.helloworld.WorkInfoHumanReply(
    position,
    humanRequest
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[WorkInfoHumanReply])
}
