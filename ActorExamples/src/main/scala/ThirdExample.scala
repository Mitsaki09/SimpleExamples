...
object ZabegSvinkiMain extends App {
  ...
  val svinka1 = Svinki("Артём",1)
  val svinka2 = Svinki("Алексей",673)

  val svinka3 = Svinki("Артём",1)
  val svinka4= Svinki("hhhhh",673)

  val svinka5 = Svinki("Артём",1)
  val svinka6 = Svinki("Алекkkkkkkсей",673)
